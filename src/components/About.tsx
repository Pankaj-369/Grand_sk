        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Founded by visionary entrepreneur <span className="font-semibold text-amber-600">Nitesh Chhabra</span>, 
                The Grand SK Cafe and Lounge represents the perfect fusion of contemporary cafe culture and 
                sophisticated lounge elegance.
              </p>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Located in the heart of Satya Niketan, our establishment offers a sanctuary where coffee 
                enthusiasts, food lovers, and social butterflies converge to create unforgettable experiences.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                From meticulously crafted artisanal beverages to gourmet culinary creations, every detail 
                at The Grand SK is designed to exceed your expectations and create lasting memories.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center group">
              ...
              <h4 className="text-xl font-semibold text-gray-800 mb-2">Premium Coffee</h4>
            ...
            <div className="text-center group">
              ...
              <h4 className="text-xl font-semibold text-gray-800 mb-2">Community Hub</h4>
            ...
            <div className="text-center group">
              ...
              <h4 className="text-xl font-semibold text-gray-800 mb-2">Made with Love</h4>
